...
var OPACITY = {
  ...
  TYPE_COLORS = ["#E8BA20", "#D47F23", "#AE007E", "#673C8B", "#009BDB", "#0095B0", "#7C7B7E"],
  TYPE_HIGHLIGHT_COLORS = ["#EFCF90", "#E0A87A", "#C87AAB", "#9274AA", "#92BED6", "#77B5BD", "#ADADAD"],
  LINK_COLOR = "#b3b3b3",
  INFLOW_COLOR = "#2E86D1",
      ...
      tooltip
        ...
        .transition()
          ...
          .text(function () {
            ...
            return g.name + "\nAfecta a " + (g.sourceLinks.length)/2 + " Indicadores"  + additionalInstructions;
          });
    }
  });
